  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Zkuste to prosím znovu, nebo se vraťte na úvodní stránku.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Pro Řevnice — Starostové a nezávislí" },
      {
        name: "description",
        content:
          "Pro Řevnice — kandidátka hnutí Starostové a nezávislí do zastupitelstva města Řevnice. Otevřená a odpovědná politika pro naše město.",
      },
      { property: "og:site_name", content: "Pro Řevnice" },
